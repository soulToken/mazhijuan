  ...
  <div class="box" style>
    ...
    <div class="captop">
      ...
      <div style="min-width:242px;">
        ...
        <div
          @click="szpass = true"
          v-if="zijinarr.setPayPassword == false"
    ...
    <div class="back">
      ...
      <el-table :data="back" :stripe="true" border style="width: 100%;text-align: center">
        <el-table-column label="账户类型">对公银行账户</el-table-column>
        <el-table-column prop="accountName" label="开户名"></el-table-column>
        <el-table-column prop="cardNo" label="银行账号"></el-table-column>
        <el-table-column prop="areaName" label="开户银行地区"></el-table-column>
        <el-table-column prop="branchName" label="开户银行"></el-table-column>
        <el-table-column prop="bankName" label="开户支行名称"></el-table-column>
      </el-table>
    </div>
    ...
    <div class="cx_message" v-if="czshow">
      <div>
        <p>充值</p>
        <img @click="czshow=false" src="../../../static/img/esc.png" alt />
      </div>
    ...
    <div class="cx_message cz_message" v-if="czpass">
      <div>
        <p>充值</p>
        <img @click="czpass=false" src="../../../static/img/esc.png" alt />
      </div>
      <div class="message_val">
        <p>请输入充值密码</p>
        <div class="qtje">
          <input type="text" v-model="CpayPassword" placeholder />
          <span @click="wjpass=true">忘记密码？</span>
        </div>
    ...
    <div class="cx_message cz_message" v-if="czgood">
      <div>
        <p>{{currentType==2?'提现':''}}{{currentType==1?'充值':''}}</p>
        <img @click="czgood=false" src="../../../static/img/esc.png" alt />
      </div>
      <div class="message_val czgood_val">
        <div class="ts">
          <img src="../../../static/img/good.png" alt />
          <p>{{currentType==1?'充值成功':''}}{{currentType==2?'提现成功':''}}</p>
        </div>
    ...
    <div class="cx_message cz_message" v-if="szpass">
      <div>
        <p>设置充值密码</p>
        <img @click="szpass=false" src="../../../static/img/esc.png" alt />
      </div>
      <div class="szpass">
        <p>【设置充值密码】</p>
        <div>
          <p>支付密码：</p>
          <input type="text" v-model="password" placeholder="请输入支付密码" />
        </div>
        <div>
          <p>确认支付密码：</p>
          <input type="text" v-model="newPassword" placeholder="请再次输入支付密码" />
        </div>
    ...
    <div class="cx_message cz_message" v-if="passgd">
      <div>
        <p>充值</p>
        <img @click="passgd=false" src="../../../static/img/esc.png" alt />
      </div>
      <div class="message_val czgood_val">
        <div class="ts">
          <img src="../../../static/img/good.png" alt />
    ...
    <div class="cx_message back_message" v-if="backbd">
      <div>
        <p>绑定银行卡</p>
        <img @click="backbd=false" src="../../../static/img/esc.png" alt />
      </div>
      <div class="szpass backdb">
        <p style="margin-bottom: 30px">【绑定银行卡】</p>
        <div>
          <p>银行账户类型：</p>
          <input type="text" v-model="accountType" readonly="readonly" />
        </div>
        <div>
          <p>开户名：</p>
          <input type="text" v-model="accountName" readonly="readonly" />
        </div>
        <div>
          <p>银行账户：</p>
          <input type="text" v-model="cardNo" placeholder="请输入支付密码" />
        </div>
        <div>
          <p>开户银行所在地：</p>
          <input type="text" v-model="areaName" placeholder="请再次输入支付密码" />
        </div>
        <div>
          <p>开户银行：</p>
          <input type="text" v-model="bankName" placeholder="请输入支付密码" />
        </div>
        <div>
          <p>开户银行支行名称：</p>
          <input type="text" v-model="branchName" placeholder="请再次输入支付密码" />
        </div>
        <div>
          <p>银行预留手机号码：</p>
          <input type="text" v-model="mobile" placeholder="请输入支付密码" />
        </div>
        <div>
          <p>验证码：</p>
          <input type="text" v-model="checkCode" placeholder="请再次输入支付密码" />
        </div>
        <p></p>
      </div>
      <ul>
        <li @click="tobackbd">绑定</li>
        <li @click="backbd=false">取消</li>
      </ul>
    </div>
    <div class="cx_message cz_message" v-if="backgd">
      <div>
        <p>绑定银行卡</p>
        <img @click="backgd=false" src="../../../static/img/esc.png" alt />
      </div>
      <div class="message_val czgood_val">
        <div class="ts">
          <img src="../../../static/img/good.png" alt />
    ...
    <div class="cx_message cz_message" v-if="wjpass">
      <div>
        <p>找回密码</p>
        <img @click="wjpass=false" src="../../../static/img/esc.png" alt />
      </div>
    ...
    <div class="cx_message cz_message" v-if="zhpass">
      <div>
        <p>找回密码</p>
        <img @click="zhpass=false" src="../../../static/img/esc.png" alt />
      </div>
      <div class="szpass">
        <p>【找回支付密码】</p>
        <div>
    ...
    <div class="cx_message cz_message" v-if="zhpassgd">
      <div>
        <p>找回密码</p>
        <img @click="zhpassgd=false" src="../../../static/img/esc.png" alt />
      </div>
      <div class="message_val czgood_val">
        <div class="ts">
          <img src="../../../static/img/good.png" alt />
    ...
    <div class="cx_message back_message" v-if="Transfer">
      <div>
        <p>转账</p>
        <img @click="Transfer=false" src="../../../static/img/esc.png" alt />
      </div>
      <div class="Transfer">
        ...
        <div>
          <div>
            <p>收款方开户名：</p>
            <input type="text" placeholder="请输入收款方开户名" />
          </div>
          <div>
            <p>收款方银行账户：</p>
            <input type="text" placeholder="请输入收款方银行账户" />
          </div>
          <div>
            <p>收款方开户银行：</p>
    ...
    <div class="cx_message cz_Transferyes" v-if="TransferYes">
      <div>
        <p>转账</p>
        <img @click="TransferYes=false" src="../../../static/img/esc.png" alt />
      </div>
      <div class="Transfer Transferyes">
        ...
        <div>
          <div>
            <p>收款方开户名：</p>
            <input type="text" placeholder="请输入收款方开户名" readonly="readonly" />
          </div>
          <div>
            <p>收款方银行账户：</p>
            <input type="text" placeholder="请输入收款方银行账户" readonly="readonly" />
          </div>
          <div>
            <p>收款方开户银行：</p>
            <input type="text" placeholder="请选择开户银行" readonly="readonly" />
          </div>
        </div>
        <p style="text-align: right;padding-right: 30px;font-size: 14px">
          转账金额：
          <span style="color: #ff0000;font-size: 16px">￥30000.00</span>
        </p>
      </div>
    ...
    <div class="cx_message" v-if="Presentation">
      <div>
        <p>提现</p>
        <img @click="Presentation=false" src="../../../static/img/esc.png" alt />
      </div>
      <div class="message_val">
        <p>【提现】</p>
        <div>
        ...
        <div class="je">
          <p
            v-for="(a,index) in withdraw"
            @click="Tchange(a,index)"
            :class="{Selection:Tnumber == index}"
          >￥{{a}}</p>
        </div>
        <div class="qtje">
          <span>￥</span>
          <input type="text" v-model="cashValue" placeholder="请输入其他金额" />
        </div>
        <p
          style="font-size: 14px;color: #666;margin-left: 110px"
        >当前用户可用余额：{{zijinarr.balance-zijinarr.frozenBalance}}</p>
    ...
    <div class="cx_message" v-if="czshow">
      ...
      <div class="message_val">
        ...
        <div class="je">
          <p
            v-for="(a,index) in recharge"
            @click="Cchange(a,index)"
            :class="{Selection:Cnumber == index}"
          >￥{{a}}</p>
        </div>
        <div class="qtje">
          <span>￥</span>
          <input type="text" v-model="Cpay" placeholder="请输入其他金额" />
        </div>
        <p class="xy" @click="goPay">下一步</p>
      </div>
    </div>
    <!-- //detailed -->
    <div class="cx_message detailed" v-if="detailed" style="display:flex;flex-direction:column;">
      <div>
        <p>资金明细</p>
        <img @click="detailed=false" src="../../../static/img/esc.png" alt />
      </div>
      <div class="detailed_val" style="flex:1;background:#fff;overflow:auto;padding:20px 0 0 20px;">
        <div style="display:flex;">
          ...
          >
            ...
            <el-table-column prop="w" label="姓名" align="left">
              <template slot-scope="scope">
                <div v-if="scope.$index==0" style="text-align:left;">
                  <el-date-picker
                    style="width:300px;"
                    v-model="value1"
                    type="daterange"
                ...
                <div v-else style="text-align:left;">
                  ...
                  <el-button
                    type="primary"
                    style="width:90px;height:23px;line-height:0px;background:#25c6da;margin-left:20px;"
                  >查询</el-button>
                </div>
              </template>
            </el-table-column>
          ...
          <el-button
            type="primary"
            style="width:90px;height:23px;line-height:0px;margin:30px 30px 0 20px;"
          >基本筛选</el-button>
        </div>
            ...
            <el-table-column label="姓名" align="left">
              <template slot-scope="scope">
                <div v-if="scope.$index==0" style="text-align:left;">
                  ...
                  <span
                    class="type_tt"
                    :class="{active:currentBtnType2==0}"
                    @click="currentBtnType2=0"
                  >今天</span>
                  <span
                    class="type_tt"
                    :class="{active:currentBtnType2==1}"
                    @click="currentBtnType2=1"
                  >近一月</span>
                  <span
                    class="type_tt"
                    :class="{active:currentBtnType2==2}"
                    @click="currentBtnType2=2"
                  >近三月</span>
                  <span
                    class="type_tt"
                    :class="{active:currentBtnType2==3}"
                    @click="currentBtnType2=3"
                  >近一年</span>
                </div>
                <div v-else style="text-align:left;">
                  <span
                    class="type_tt"
                    :class="{active:currentBtnType==0}"
                    @click="currentBtnType=0"
                  >全部</span>
                  <span
                    class="type_tt"
                    :class="{active:currentBtnType==1}"
                    @click="currentBtnType=1"
                  >收入</span>
                  <span
                    class="type_tt"
                    :class="{active:currentBtnType==2}"
                    @click="currentBtnType=2"
                  >支出</span>
                  <span
                    class="type_tt"
                    :class="{active:currentBtnType==3}"
                    @click="currentBtnType=3"
                  >充值</span>
                  <span
                    class="type_tt"
                    :class="{active:currentBtnType==4}"
                    @click="currentBtnType=4"
                  >提现</span>
                </div>
              </template>
            </el-table-column>
        ...
        <div style="padding-right:20px;margin-top:30px;">
          <el-table :data="tableData" border style="width:100%;">
            <el-table-column prop="date" label="日期" width="180"></el-table-column>
            <el-table-column prop="empNo" label="交易流水号" width="180"></el-table-column>
            <el-table-column prop="type" label="类型"></el-table-column>
            <el-table-column width="200" prop="message" label="目标信息"></el-table-column>
            <el-table-column prop="tridetype" label="交易分类"></el-table-column>
            <el-table-column prop="money" label="金额（元）">
              <template slot-scope="scope">
                <div
                  :style="{'color':scope.row.money.indexOf('+')>-1 ?'#fe0103 ':'#06cb01'}"
                >{{scope.row.money}}</div>
              </template>
            </el-table-column>
          </el-table>
...
export default {
  ...
  data() {
    return {
      tableData: [
        {
          date: "2016-05-03",
          empNo: "2019012313123123",
          name: "王小虎",
          type: "直播",
          tridetype: "收入",
          message: "上海迅阁点击科技有限公司",
          money: "+10000",
        ...
        },
        {
          ...
          type: "中国银行",
          tridetype: "支出",
          message: "622 848 07124 8765 7654",
          empNo: "2019012313123126",
          money: "+10000",
          address: "上海市普陀区金沙江路 1518 弄"
        },
        {
          ...
          tridetype: "支出",
          money: "+10000",
          empNo: "2019012313123120",
          message: "622 848 07124 8765 7654",
          empNo: "2019012313123143",
          address: "上海市普陀区金沙江路 1518 弄"
        },
        {
          date: "2016-05-06",
      ...
      value1: "",
      value2: "",
      listData: [{ name: "金额范围：" }, { name: "交易流水号：" }],
      listData2: [{ name: "交易时间：" }, { name: "交易分类：" }],
      Cpay: null,
      cashValue: null,
      CpayPassword: "",
      cardNo: "",
  ...
  methods: {
    ...
    getBanlance() {
      this.$http
        .get("/api/api/fund/accountInfo/getBalance")
        .then(function(res) {
          ...
          this.$http
            .get("/api/api/fund/bankcard/company/findAll")
            .then(function(res) {
              if (res.body.code == 200) {
    ...
    confirmPassword() {
      ...
      this.$http
        .post("/api/api/fund/accountInfo/setPayPassword", {
    ...
    goPay2() {
      ...
      let money =
        this.Tnumber > -1 ? this.withdraw[this.Tnumber] : this.cashValue;
    ...
    tobackbd() {
      ...
      var self = this;
      this.$http
        .post("/api/api/fund/bankcard/company/bindCard", {
          cardNo: this.cardNo,
...
.nohover .el-table__body tr:hover > td {
...
.captop > div:nth-of-type(4) > div:nth-of-type(3),
.captop > div:nth-of-type(4) > div:nth-of-type(4) {
  margin-top: 20px;
}
